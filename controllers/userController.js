...
class userController {
  static home = async(req, res) => {
    const ApiCards = await Card.find({});/* finding inside Card database in cluster*/
    // console.log(result)
  ...
  static createUserDoc = async (req, res) => {
    ...
    try {
      ...
      if (existingUser) {
        return res.send('User with this email already exists. <a href="/signup">Go back to home page</a>')
      }
